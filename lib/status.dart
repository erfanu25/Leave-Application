...
class MessageList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //pop up message
    Future<Null> _neverSatisfied(String name,String email,String phone,String from,String to,String type,String reason) async {
    ...
    return new StreamBuilder<QuerySnapshot>(
      stream: firestore.collection(uname).snapshots(),
        ...
        return new ListView.builder(
          ...
          itemBuilder: (_, int index) {
            ...
            return new GestureDetector(
                onTap: (){_neverSatisfied(document['name'],document['email'],document['phone'],document['from'],document['to'],document['leave'],document['reason']);},
                child: new Column(
                  children: <Widget>[
                    new Padding(
